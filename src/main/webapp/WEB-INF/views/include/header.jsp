...
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Gothic+A1:wght@300&display=swap" rel="stylesheet">
...
<body>
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<a href="/biz" class="logo mr-auto"><img
				src="resources/assets/img/bizLogo.png" alt="" class="img-fluid"></a>
